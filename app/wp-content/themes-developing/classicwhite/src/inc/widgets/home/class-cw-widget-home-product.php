<?php
/**
 * Widget API: CW_Widget_Home_Product class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.8.1
 ...
 * @see WP_Widget
 */
class CW_Widget_Home_Product extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			'description' => __( 'Lista de productos a mostrar', 'classicwhite-theme' )
		);

		parent::__construct(
			strtolower( get_class( $this ) ),
			__( 'Home Productos Widget', 'classicwhite-theme' ),
			$widget_ops
		);
	...
	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Productos', 'classicwhite-theme' );
		}
		// Widget admin form
		?>
		<p>
